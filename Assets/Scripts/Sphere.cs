...
public class Sphere {
	...
	public bool closestRayIntersects(Vector3 rayPos, Vector3 rayLook, Vector3 point, ref Vector3 intersection)
	{
		// Calculate p0-c call it v
		
		Vector3 v = rayPos - Position;
		...
		/*
             *  a = u.u
                ...
                c = (p0 – c).(p0 – c) - r2
            */
		a = Vector3.Dot(rayLook, rayLook);
		b = 2.0f * Vector3.Dot(v, rayLook);
		...
		if (discriminant >= 0.0f)
		{
			...
			p0 = rayPos + (rayLook * t0);
			p1 = rayPos + (rayLook * t1);
